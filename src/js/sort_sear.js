...
getList();
function getList() {
    // https://www.duitang.com/napi/blog/list/by_search/?kw=yi&type=feed&include_fields=top_comments%2Cis_root%2Csource_link%2Citem%2Cbuyable%2Croot_id%2Cstatus%2Clike_count%2Clike_id%2Csender%2Calbum%2Creply_count%2Cfavorite_blog_id&_type=&start=24&_=1618560300127
    if(!flag) return;
    flag = false;
    ajax({
    url: '/dt_search',
